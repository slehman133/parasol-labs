  ...
  return (
    ...
    <div className='border border-white p-4 md:p-10 mx-auto my-4 md:my-auto rounded-md md:grid md:grid-cols-2 gap-5'>
      <div className='text-center md:text-left'>
        ...
        <p className='font-thin mt-2 md:w-2/3 mx-auto'>We&apos;re here to help. Get the conversation started by filling out the form and we will get back to you as soon as possible.</p>
