...
import { Button, Card, CardHeader, Divider, Image, Input, Link, Textarea } from "@nextui-org/react";
    ...
    <div>
      ...
      <div className="pt-4">
        ...
        <div className="grid grid-cols-[50%_50%] px-10 gap-5">
          ...
          <div>
            <img src="/images/homepagelady.png" alt="Teagan Paddleton and her baby, Oakley." className="h-3/4 mx-auto my-auto boxshadow" />
          </div>
        </div>
        ...
        <section className="content">
          ...
          <div className="grid grid-row-1 grid-cols-4 justify-center gap-x-unit-3xl mx-auto">
            <div className="mx-auto">
              ...
              <p className="font-semibold text-slate-400">Angel Kids Pediatrics<br />I Nurse My Baby<br />Center for Medicare & Medicaid Services</p>
            </div>
            <div className="mx-auto my-auto">
              <ProfilePicture imageUrl="/images/christine_davies.jpg" />
              <h1 className="font-semibold">Christine Davies</h1>
              <p className="font-semibold text-slate-400">Angel Kids Pediatrics<br />Board Certified Lactation Consultant</p>
            </div>
            <div className="mx-auto">
              <ProfilePicture imageUrl="/images/megan_gregg.jpg" />
              <h1 className="font-semibold">Megan Gregg</h1>
              <p className="font-semibold text-slate-400">15+ years of experience building startups in SaaS, MarTech, F&B, and E-commerce <br />Founding Member of Women in Tech</p>
            </div>
            <div className="mx-auto">
              <ProfilePicture imageUrl="/images/scott_kelly.jpeg" />
              <h1 className="font-semibold">Scott Kelly</h1>
              <p className="font-semibold text-slate-400">Black Dog Venture Partners</p>
            </div>
          </div>
        </section>
        <Divider orientation="horizontal" className="my-10" />
        <section className="content">
          <div className="grid grid-row-1 grid-cols-2 gap-x-unit-2xl">
                ...
                <div className="contact-box py-2" >
                  <div className="flex items-center"> {/* Use flex container to align items vertically */}
                    ...
                    <div className="w-auto">
                      ...
                      <Link className="text-2xl font-bold" href="/webforms/partnershipform" underline="always" color="foreground">Partnership Form</Link>
                    </div>
            ...
            <div>
              <img src="/images/teagan_and_frankie.png" alt="Teagan Padelford & Frankie Civiletto, with her baby, Oakley." />
              <div className="pt-5 text-left">
                <h1 className="font-bold text-2xl">Recent News</h1>
              </div>
              <div className="grid grid-row-1 grid-flow-cols gap-5 flex-col py-5">
                <Link href="https://wefunder.com/parasol.laboratories.incorporated" target="_blank">
                  <Card className="h-[300px]">
                    <CardHeader className="z-10 absolute flex-col !items-start top-1">
                      <p className="text-tiny text-white/60 uppercase font-bold">STRL</p>
                      <h4 className="text-white font-medium text-large">Support us through WeFundr</h4>
                    </CardHeader>
                    <Image
                      removeWrapper
                      alt="STRL WeFundr"
