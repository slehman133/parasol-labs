...
export default function Footer() {
  return (
    <footer className="bg-inherit footer p-10 border-t-1 mx-auto">
      <aside>
      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          <a target="_blank" href="http://www.youtube.com/@ParasolLabs">
            <svg
          ...
          <a target="_blank" href="https://www.instagram.com/parasollabs/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a target="_blank" href="https://twitter.com/parasollabs">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a target="_blank" href="https://www.facebook.com/parasollabs">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
